       ...
       return(
        ...
        >    
             ...
             >
                 ...
                 <Input marginLeft={'50px'}  outline='none !important' width={'300px'} height='35px'
                        borderRadius={'4px'} placeholder='Email hoặc số điện thoại' bg={'aliceblue'}></Input>
                 <Input marginLeft={'50px'} marginTop='15px' outline='none !important' width={'300px'} height='35px'
                        borderRadius={'4px'} placeholder='Mật khẩu' bg={'aliceblue'}></Input>
                 <Link href=""><Button width={'300px'} height='50px' bg='rgb(219, 64, 53)'
                         marginTop={'20px'} marginLeft='50px' color={'white'}>Gửi</Button></Link>
             </Box>
        </Box>
       )
}